...
public class q1 {
    ...
    public static void removerInicio(Celula controle[])  {
        Celula temp= controle[0].prox;
        controle[0].prox=temp.prox;
        temp.prox=temp=null;
    }
    ...
    public static String removerNaPosicao(Celula controle[],int posicaoDesejada)  {
        ...
        temporaria=controle[0].prox.prox;
        ...
        aux=temporaria.prox;
        resposta=aux.atual.getNome();
        temporaria.prox=aux.prox;
        aux.prox=aux=temporaria=null;
        }
        return resposta;
